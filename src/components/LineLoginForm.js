...
import './LineLoginForm.css'; // Make sure this path is correct based on your project structure
import img12 from './Images/img12.png';

export const LineLoginForm = () => {
  return (
    <div>
      ...
      <div className="transparent-box1">
        <form action="">
          <center><img src={img12}></img></center>
          <h2>Line Manager Login</h2>
